            ...
            groupContents: [{
                ...
                },
                {
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '国民生活基礎調査による、要介護となる原因として2番目に多いのはどれか。',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '「筋肉減少を主体として、筋力、身体機能の低下を呈する病態」を英語で答えよ（すべて小文字）。',
                    //   choices:["","","","",""],
                    answerImg: [],
                    answer: 'sarcopenia',
                    commentary: '筋肉の + 減少',
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '100グラムの牛肉に含まれるたんぱく質の量に最も近いのはどれか。',
                ...
                },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '以下の予防活動のうち、ポピュレーションアプローチにあてはまるのはどれか。すべて選べ。',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '小学生の学校健診で毎年実施する必要がある検査はどれか。すべて選べ。',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '臨床検査特性を表す指標で、疾病なしの対象者の検査結果が陰性にでる確率のことを英語で何というか（すべて小文字）',
                      // choices:["","","","",""],
                    answerImg: [],
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '臨床検査特性を表す指標で、疾病ありの対象者の検査結果が陽性にでる確率のことを英語で何というか（すべて小文字）',
                      // choices:["","","","",""],
                    answerImg: [],
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '対象者が含まれる集団の有病率によって変化する指標はどれか。すべて選べ。',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      'プライマリケア現場で、検査前確率（有病率）20％の疾患を疑う患者が受診した。陽性尤度比4.0の検査が陽性であった場合、患者が当該疾患である検査後確率は何％か。回答欄には整数を入力（小数点以下は四捨五入してください）。',
                      // choices:["","","","",""],
                    answerImg: [],
                    answer: '50',
                  ...
                  },
                  {
                    ...
                    questionSentence:
                      '右の図は５つの臨床検査のROC曲線である。もっとも性能の高い検査はどれか。',
                      choices:["A","B","C","D","E"],
                    answerImg: [],
                    answer: 'A',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '日本救急医学会による熱中症分類（2015）に従うと、医療機関への受診が必要と考えられる症状は以下のどれか。１つ選べ。',
                  ...
                  },
                  {
                    ...
                    questionImg: [],
                    questionSentence:
                      '作業環境の気圧が急激に上昇する際にみられる症状は以下のどれか。１つ選べ。',
                      choices:["関節痛","空気塞栓","スクイーズ","窒素酔い","酸素中毒"],
                    answerImg: [],
                    answer: 'スクイーズ',
                    commentary: '関節痛と空気塞栓は気圧が減圧された時に起こる症状。窒素良いと酸素中毒は加圧時に血中に溶け込んで発症する。理屈で覚えておけば暗記する必要はない。',
                  },
                  {
                    detailInfo: '6/22 出席課題',
                    questionImg: [],
                    questionSentence:
                      '騒音性難聴について正しいのはどれか。１つ選べ。',
                      choices:["曝露初期から聴力の低下がみられる","鼓膜や耳小骨の損傷を伴うことが多い","感音難聴に分類される","内有毛細胞に変性がみられる","初期症状は、6000ヘルツ以上の高音の聴力低下である"],
                    answerImg: [],
                    answer: '感音難聴に分類される',
                    commentary: '暴露に応じて症状が悪化する。変性するのは外遊網細胞。高齢者の加齢西南町と八個となり、4000ヘルツ以下の低い音域から症状が始まる。',
                  },
                  {
                    detailInfo: '6/22 出席課題',
                    questionImg: [],
                    questionSentence:
                      'じん肺法が定める合併症に含まれないのはどれか。１つ選べ。',
