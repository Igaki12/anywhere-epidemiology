    ...
    const [questionList, setQuestionList] = useState([
        // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
        {
...

            {
                ...
                questionImg: [],
                questionSentence:
                    '個人レベルでは突合できない既存の集団レベルデータを用いて、曝露とアウトカムの関連を調査する研究デザインを英語で何というか。（すべて小文字）',
                answerImg: [],
            ...
            },
            {
                ...
                questionImg: [],
                questionSentence:
                    '曝露とアウトカムを同じ時点で調査し、両者の関連を調査する研究デザインを英語で何というか。（すべて小文字）',
                answerImg: [],
            ...
            },
            {
                ...
                questionImg: [],
                questionSentence:
                    '横断研究によって示すことができないものは以下のどれか。もっとも当てはまるものを１つ選べ。',
                answerImg: [],
            ...
            },
            {
                ...
                questionImg: [],
                questionSentence:
                    '疾病Ａを発症していない対象者で、要因Ｂへの曝露者と非曝露者を対象として、20年間の疾病Ａの罹患率を調査した。この研究デザインを英語の記載せよ（すべて小文字）。',
                answerImg: [],
            ...
            },
            {
                ...
                questionImg: [],
                questionSentence:
                    '2023年において、2000年から2010年にA病院に胃がんで手術を受けたすべての患者400名のカルテ情報を用いて、手術前の検査でアルブミンが低値の患者と、それ以外の患者で、術後10年間の死亡率を比較した。この研究は以下のどれか。',
                answerImg: [],
